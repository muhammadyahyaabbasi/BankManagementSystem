...
public class WithdrawPage {
    ...
    public static void display() {
        ...
        window.setTitle("Withdraw Funds");
        ...
        withdrawBtn.setOnAction(e -> {
            ...
            processWithdrawal(accountId, amount, window);
        });

        VBox layout = new VBox(20, title, accountIdField, amountField, withdrawBtn);
    ...
    private static void processWithdrawal(int accountId, double amount, Stage window) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                // Ensure the account has enough funds for withdrawal
    ...
    private static void showReceipt(int accountId, String firstName, String lastName, double amount, double remainingBalance) {
        ...
        Label transactionLabel = new Label("Transaction: Withdrawal");
        Label amountLabel = new Label("Amount Withdrawn: $" + amount);
